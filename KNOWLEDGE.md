...
**State: LIVE, active.** Git repo → github.com/NoamVardi18/Avi-vardi, deployed on Vercel, clean working tree. Last 10 commits: SEO (llms.txt, AI-crawler allow, Jerusalem keywords, FAQ schema), editorial redesign, Vercel Analytics/Speed Insights, uptime auto-restart cron. archive/todo.md shows 6 phases all `[x]` complete.
