...
var SUPABASE_URL = "https://nlwkksivgubcgfzqivcs.supabase.co";
var SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5sd2trc2l2Z3ViY2dmenFpdmNzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk5NjI1NTUsImV4cCI6MjA5NTUzODU1NX0.Z0rNzhIAxUVG33c4hnj4bNWPwDGbqV-WnWPkixnUzUI";
...
// server/routers.ts
var OWNER_WHATSAPP = "972524804842";
...
`;
      msg += `\u{1F464} *\u05E9\u05DD:* ${input.name}
`;
      msg += `\u{1F4DE} *\u05D8\u05DC\u05E4\u05D5\u05DF:* ${input.phone}
`;
      if (input.tripDate) msg += `\u{1F4C5} *\u05EA\u05D0\u05E8\u05D9\u05DA:* ${input.tripDate}
`;
      if (input.notes) msg += `\u{1F4DD} *\u05E4\u05E8\u05D8\u05D9\u05DD:* ${input.notes}
`;
      msg += `
\u05E0\u05E9\u05DC\u05D7 \u05DE\u05D4\u05D0\u05EA\u05E8 \u05D0\u05D5\u05D8\u05D5\u05DE\u05D8\u05D9\u05EA`;
